    ...
    <CitizenNav>
      <div className="max-w-[1200px] mx-auto px-6 py-20 flex flex-col items-center justify-center text-center gap-5">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={() => navigate("/projects")} className="px-4 py-2 bg-[#F1F5F9] hover:bg-[#E2E8F0] text-[#0F172A] text-[14px] font-medium rounded-[6px] transition-colors">View Projects</button>
        </div>
      </div>
    </CitizenNav>
  )
