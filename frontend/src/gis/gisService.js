// Integration boundary between CIVIQ records and GIS primitives. The coordinate
// and GeoJSON modules stay free of application knowledge; this is the one place
// that knows where a project or complaint keeps its location.
...
// Project.location.geoJSON is free-form on the backend, so it is parsed
// defensively; a record with no usable coordinate returns null.
